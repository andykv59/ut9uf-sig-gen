...
The pushbutton goes to pin 7 to set the tuning rate.
Pin 10 is the RX/TX pin. Put this pin LOW for RX, open or high for TX.
...
int txpin = 10;
int freqsteps = 1;
int stepbutton = 7;  // was 11 Andy changed to 7
